...
const BillingCard = ({purData}) => {
  return (
    <div className="border p-4 rounded-lg bg-white shadow-md hover:shadow-xl border-brand-fourth">
      <div>
        <div className="flex mb-4">
          <FaReceipt
            ...
            size={30}
          />
          <p className="self-center ml-auto bg-[#f1f5f9] text-brand-secondary border-brand-fourth text-xs border px-3 p-0.5 rounded-xl">
            Billing
          </p>
        </div>
